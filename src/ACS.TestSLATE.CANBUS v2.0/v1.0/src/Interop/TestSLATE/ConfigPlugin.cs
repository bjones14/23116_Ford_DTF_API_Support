// <copyright file="ConfigPlugin.cs" company="Jacobs Technology, Inc.">
//     Copyright (c) Jacobs Technology, Inc. All rights reserved.
// </copyright>
// <summary>This class is what loads the plugin into Test SLATE.</summary>
//   Remove this file from Project if editor does not support configuration node.
...
namespace Customer.TestSLATE.Mnemonic.Interop.TestSLATE
{
    ...
    public sealed class ConfigPlugin : IPlugin
    {
        ...
        public string Name
        {
            get { return Resources.PluginName + Resources.ConfigPluginAppender; }
        }
        ...
        private static void OnAddClick(object sender, EventArgs e)
        {
            ...
            CreateChildNode(source, cell, root);
            root.Expand();
        }
        ...
        private static void CreateChildNode(TSSource source, TSCell cell, SystemExplorerNode root)
        {
            var node = new ConfigNode(source, cell);
        ...
        private static void CreateCommandDeliveryProcess(Environment environment, TSCell cell, TSMnemonic mnemonic, TSSource source)
        {
            ...
            {
                cmdDelProcess.ProcessName = source.SourceName;
                cmdDelProcess.SourceID = source.SourceID;
                cmdDelProcess.Save();
                return;
            }
        ...
        {
            var node = new ConfigNode {Tag = parentNode.Tag};
