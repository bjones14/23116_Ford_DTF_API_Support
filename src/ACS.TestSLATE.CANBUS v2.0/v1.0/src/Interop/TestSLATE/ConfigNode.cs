// <copyright file="ConfigNode.cs" company="Jacobs Technology, Inc.">
...
namespace Customer.TestSLATE.Mnemonic.Interop.TestSLATE
{
    ...
    using Customer.TestSLATE.Mnemonic.Interop.LabVIEW;

    /// <summary>
    ///   This class is basic node for the config nodes and editors.
    /// </summary>
    public sealed class ConfigNode : SystemExplorerNode
    {
        /// <summary>
        /// The Source.
        /// </summary>
        ...
        public ConfigNode(TSSource source, TSCell cell)
        {
            this._cell = cell;
            this._source = source;
        }
        ...
        private void OnEditClick(object sender, EventArgs e)
        {
            ...
            var environment = EnvironmentFactory.CellEnvironment();
            var cells = environment.Cells.SelectByCellID(config.CellID);
        ...
        /// </summary>
        /// <returns></returns>
        private IView OpenEditor(TSConfig config)
        {
            var editor = new Editor (_cell, config, _source)
                             {
