...
namespace Jacobs.TestSLATE.PluginTemplate.Models
{
    ...
    /// </summary>
    [Serializable]
    public class RFMConfigItem : IComparable<RFMConfigItem>, IEquatable<RFMConfigItem>, IEditableObject, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public RFMConfigItem(string ItemName, string ItemValue)
        {
        ...
        public void BeginEdit()
        {
            ...
            this._backup = CreateNewRFMConfigItem("", "0");
        ...
        /// </summary>
        /// <returns></returns>
        public static RFMConfigItem CreateNewRFMConfigItem(string itemName, string itemAddr)
        {
